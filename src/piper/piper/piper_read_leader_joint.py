...
class PiperRosNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.srv = self.create_service(SetBool, '~/enable_teleop', self.enable_teleop_callback)
    ...
    def enable_teleop_callback(self, request, response):
        if request.data:
    ...
    def PublishArmJointAndGripper(self):
        ...
        # new_time = max(self.piper.GetArmJointCtrl().time_stamp, self.piper.GetArmHighSpdInfoMsgs().time_stamp)
        ...
        joint_1: float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_1 / 1000) * 0.017444
        joint_2: float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_2 / 1000) * 0.017444
        joint_3: float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_3 / 1000) * 0.017444
        joint_4: float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_4 / 1000) * 0.017444
        joint_5: float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_5 / 1000) * 0.017444
        joint_6: float = (self.piper.GetArmJointCtrl().joint_ctrl.joint_6 / 1000) * 0.017444
